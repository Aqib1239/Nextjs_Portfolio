...
const Hero = () => {
  ...
  return (
    <section className='py-12 xl:py-24 xl:h-[84vh] md:h-[100vh] md:pb-20 sm:h-[104vh] sm:pb-24 xl:pt-28 bg-hero    
        ...
        <div className="container mx-auto">
          <div className='flex flex-col xl:flex-row justify-between gap-x-8'>
            <div className='flex order-1 max-w-[600px] flex-col justify-center mx-auto xl:mx-0 text-center xl:text-left'>
              ...
              whileInView={"visible"}
              initial="hidden"
              className='text-md uppercase font-semibold mb-4 text-primary tracking-[4px]'>Web Developer</motion.div>
              <motion.h1
              variants={animContainer(0.5)}
              initial="hidden"
              whileInView={"visible"}
              className='h1 tracking-wider'>Hello, I am Mohammad Aqib</motion.h1>
              <motion.p 
              variants={animContainer(1)}
              initial="hidden"
              whileInView={"visible"}
              id="typewriter" ref={typewriterRef} className='text-muted-foreground text-lg mb-8 mt-2 tracking-[2px] font-normal max-w-[490px] mx-auto xl:mx-0'></motion.p>
              ...
              transition={{ duration: 1, delay: 1.5 }}><Send size={18} /></motion.span> 
                    </Button> 
                </Link>

                <Link href='/MohammadAqib_Full-Stack.pdf'>
                  <Button className='gap-x-2 bg-black dark:bg-blue-950 dark:hover:bg-violet-800'>Download Resume <motion.span initial={{ opacity: 0, y: -100 }}
              whileInView={{ opacity: 1, y: 0 }}
            ...
            className='flex flex-col gap-y-3 md:flex-row gap-x-3 mx-auto xl:mx-0 mb-12'
            >
              <Socials containerStyles='flex gap-x-6 mx-auto xl:mx-0' iconStyles='text-foreground text-[30px] hover:text-primary transition-all duration-600' />
              </motion.div>
            </div>
            <div className='order-2 flex justify-center items-center relative'>
              ...
              transition={{duration: 1, delay: 1.5}}
              className="w-full max-w-[500px] h-auto max-h-[500px] bg-no-repeat" ref={container}></motion.div>
             </div>
          </div>
