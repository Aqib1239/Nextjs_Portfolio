  ...
  return (
    <section className="xl:h-[860px] pb-12 xl:py-24 mb-12">
      <div className="container mx-auto">
        ...
        <div className="flex flex-col justify-center items-center xl:flex-row gap-12 xl:gap-16">
          {/* Developer Image */}
          <motion.div
          ...
          >
            <Tabs defaultValue="personal">
              <TabsList className="w-full grid xl:grid-cols-3 xl:max-w-[520px] mx-auto xl:mx-0 border dark:border-[#32334C]">
              ...
              <TabsContent value="personal" className="mt-8">
                <motion.h3
                  ...
                  className="h3 mb-4 tracking-widest font-medium text-center xl:text-left"
                >
                ...
                >
                  ...
                  React.js, Next.js, Node.js, Express, and MongoDB, and have
                  worked on both office projects and personal projects that
                  showcase my ability to deliver clean, efficient, and modern
                  ...
                  {!showMore ? (
                    ...
                    >
                      ...
                      continuous learning attitude to every project. My goal is
                      to craft impactful digital products while growing as a
                ...
                <motion.div
                  ...
                  className="grid xl:grid-cols-2 gap-4 mt-8"
                >
                  ...
                  <div>
                    ...
                    >
                      {getData(skillData, "skills").data.map((item, index) => {
                        const { htmlCss, JS, react, dataBase, node, express } =
                          item;
                        return (
                          <div
